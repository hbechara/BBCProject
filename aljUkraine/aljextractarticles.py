...
csv_input_path = './articlesLinks1.csv'  # This should be the path to your input CSV file
csv_output_path = './articlesContent1.csv'  # This will be the new CSV file with extracted details
