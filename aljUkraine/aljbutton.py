...
def run(playwright, specified_date_str):
    ...
    page.goto("https://www.aljazeera.com/tag/ukraine-russia-crisis/")
    ...
    while True:
        ...
        if earliest_date:
            ...
            if earliest_date <= specified_date:
                ...
                with open("./aljazeera_ukraine.html", "w", encoding="utf-8") as file:
...
with sync_playwright() as playwright:
    run(playwright, "17 May 2023") # Specify the date parameter here
